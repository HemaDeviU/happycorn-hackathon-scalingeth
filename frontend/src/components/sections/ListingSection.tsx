...
export const products = [
  {
    ...
    description:
      "Beautifully crafted wooden desk organizer for your workspace.",
    price: 34.99,
  ...
  },
  {
    ...
    description:
      "Set of handmade natural soaps for a luxurious bath experience.",
    price: 19.99,
      ...
      <MaxWrapper className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {products.map((item: any, _key: number) => (
            <ListingCard key={_key} {...item} id={_key + 1} />
          ))}
        </div>
      </MaxWrapper>
    </div>
